...
/// Создается условие, если пользователь существует в базе данных он направляется на страницу личного кабинета, если в базе данных данного пользователя нет, 
/// направляется на страницу регистраци нового пользователя  
